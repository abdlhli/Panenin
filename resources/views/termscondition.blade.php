        ...
        <div class="flex justify-center">
            <div class="w-102 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-4 mx-6 mt-32 z-10">
                ...
                <p class="text-justify px-5 mt-5">
                    Syarat dan ketentuan ini mengatur penggunaan layanan kami oleh pengguna. Dengan menggunakan layanan kami,pengguna dianggap telah membaca,memahami, dan menyetujui Syarat dan Ketentuan berikut ini.
                </p>
                <h4 class="text-left text-lg font-bold pl-5 mt-5">Layanan</h4>
                <p class="text justify-center px-5">Kami menyediakan layanan penjualan hasil panen sayuran dari hasil tani penduduk lokal jember
                </p>
                <h4 class="text-left text-lg font-bold pl-5 mt-5">Harga</h4>
                <p class="text justify-center px-5">Harga produk yang ditawarkan dapat berubah sewaktu waktu tanpa pemberitahuan terlebih dahulu. Harga yang ditampilkan tidak termasuk biaya pengiriman
                </p>
                <h4 class="text-left text-lg font-bold pl-5 mt-5">Pembayaran</h4>
                <p class="text justify-center px-5">Pembayaran dapat dilakukan dengan menggunakan metode pembayaran yang tersedia pada halaman pembayaran.
                </p>
                <h4 class="text-left text-lg font-bold pl-5 mt-5">Pengiriman</h4>
                <p class="text justify-center px-5">Produk akan dikirimkan saat itu juga setelah pembayaran diterima apabila produk memang tersedia. Biaya pengiriman akan ditanggung oleh pengguna dan ditampilkan pada halaman pembayaran
                </p>
