<div id="ModalDeleteBanner{{ $banner->id_banner }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this
                {{ $banner->nama_banner }}?</p>
            <div class="flex justify-center items-center space-x-4">
                <button data-modal-toggle="ModalDeleteBanner{{ $banner->id_banner }}" type="button"
