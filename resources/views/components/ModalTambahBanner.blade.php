<div id="ModalTambahBanner" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
    ...
    <div class="relative w-full max-w-lg max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="ModalTambahBanner">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambah Banner</h3>
                <form method="POST" action="/tambahBanner" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <div class="mb-6">
                        ...
                        <div class="mb-6 flex-grow col-span-2">
                            <label for="foto_banner"
                                ...
                                <input id="foto_banner" type="file" class="hidden" name="foto_banner"
