<div id="ModalUpdateStatus{{ $order->id_pemesanan }}" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
    ...
    <div class="relative w-full max-w-lg max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="ModalUpdateStatus{{ $order->id_pemesanan }}">
                ...
                <form method="POST" action="">
                    ...
                    <div class="mb-6">
                        ...
                        <select id="id_pemesanan" name="id_pemesanan"
                            ...
                            <option hidden selected value=""> -= Pilih Untuk Merubah
                                Status Pemesanan =-
                            </option>
