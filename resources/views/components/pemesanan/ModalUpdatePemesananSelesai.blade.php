<div id="ModalUpdateStatusSelesai{{ $order->id_pemesanan }}" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
    ...
    <div class="relative w-full max-w-lg max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="ModalUpdateStatusSelesai{{ $order->id_pemesanan }}">
